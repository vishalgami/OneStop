                  ...
                  ?>
					    ...
					    <!-- <tbody>
					      ...
					      <tr>
					      	...
					      	<td data-label="Product:" style="white-space:nowrap;">
					      	  ...
					      	  <ol type="1" style="white-space:nowrap; text-align:left;" >
					      		...
					      		<li>
					      			...
					      			echo $x.") ";?><a href="order_details.php?ord_id=<?php echo $order['order_id']; ?>"><?php echo $p_name."(Quantity:";$count=count($pr_aquant)-1;
					        ...
					        <td data-label="Order placed:"  style="white-space: nowrap;"><?php   
                        ...
                        ?>
					        ...
					        <td data-label="Payment Status:"><?php 
					        	...
					        	if($payment_status=='TXN_SUCCESS' || $payment_status == "Payment Done"  || $payment_status == "SUCCESS" )
