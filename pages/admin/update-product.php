...
if(isset($_POST["update"])){
	...
	if(!is_dir($brandName)) mkdir($brandName);
	...
	&& isset($prodFit) && isset($prodSize) && isset($prodOccasion) && isset($prodPattern) && isset($prodWash) && isset($prodStock)){
		...
		$isUpdated = $prod->updateProd($prodId,$catId,$brandName,$prodName,$prodDesc,$prodPrice,$prodMrp,$prodStock,$prodPhoto,$prodFabric,$prodFit,$prodSize,$prodOccasion,$prodPattern,$prodWash);
		if($isUpdated){
			echo "<script>alert('Product Details are Updated Successfully!');window.location.href='./products.php';</script>";
		}
		else{
			echo "<script>alert('Some error occured while updating product details!');</script>"; 
		}
	}
	else{
						...
						<form class="add_product" id="" method="POST" action="" enctype="multipart/form-data">
							...
							<select class="border x" name="catId" id="cat">
								...
								foreach($allCat as $cat){
									...
									if($productCat == $prodCatName){
										echo "<option value='$prodCatId' selected>$productCat</option>";
									}
									else{
										echo "<option value='$prodCatId'>$prodCatName</option>";
									}
								?>
							...
							<select class="border x" name="subCatId" id="cat">
								<option value="" disabled>Sub Categories</option>
								<?php  
								...
								foreach($allSubCat as $subCat){
									...
									if($prodSubCat == $prodSubCatName){
										echo "<option value='$prodSubCatId' selected>$prodSubCatName</option>";
									}
									else{
										echo "<option value='$prodSubCatId'>$prodSubCatName</option>";
									}
								?>
							...
							<input type="text" id="brand" class="" required="true" name="brand" value="<?php echo $productBrand;?>" style="width:180px; border-radius:5px;">
							<hr>
							<label>Product Name : </label>
							<input type="text" id="product" class="" required="true" name="product" value="<?php echo $productName;?>" style="width:180px; border-radius:5px;">
							<hr>
							<label>Product Description : </label><br>
							<textarea id="prod_detail" class="" required="true" name="prod_detail"  style="width:500px; height:100px; border-radius:10px;"><?php echo $productDesc;?></textarea>
							<hr>
							<label>Price : </label>
							<input type="number" id="price" class="" required="true" name="price" value="<?php echo $productPrice;?>" style="width:180px; border-radius:5px;">
							<hr>
							<label>MRP: </label>
							<input type="number" id="mrp" class="" required="true" name="mrp" value="<?php echo $productMrp;?>" style="width:180px; border-radius:5px;">
							<hr>
							<label>Stock : </label>
							<input type="number" id="instock" required="true" name="stock" value="<?php echo $productStock;?>" class="" style="width:180px; border-radius:5px;">
							<hr>
							...
							<input type="text" id="id1" name="fabric" value="<?php echo $productFabric;?>"  style="width:180px; border-radius:5px;  margin-bottom: 25px;"><br id="br1" >
							<label id="lb2" >Fit : </label>
							<input type="text" id="id2" name="fit" value="<?php echo $productFit;?>"  style="width:180px; margin-bottom: 25px; border-radius:5px; "><br id="br2" >
							<label id="lb3" >Occasion: </label>
							<input type="text" id="id3" name="occasion" value="<?php echo $productOccasion;?>"  style="width:180px; margin-bottom: 25px; border-radius:5px; "><br id="br3" >
							<label id="lb4" >Size : </label>
							<input type="text" id="id4" name="size" value="<?php echo $productSize;?>"  style="width:180px; margin-bottom: 25px; border-radius:5px; "><br id="br4" >
							<label id="lb5" >Pattern: </label>
							<input type="text" id="id5" name="pattern" value="<?php echo $productPattern;?>"  style="width:180px; margin-bottom: 25px; border-radius:5px; "><br id="br5" >
							<label id="lb6" >Wash Care: </label>
							<input type="text" id="id6" name="washcare" value="<?php echo $productWash;?>"  style="width:180px; margin-bottom: 25px; border-radius:5px; "><br id="br6" >
							<input type="submit" id="submit" name="update" class="btn btn-success"/>
						</form><br>
					</div>
				</div>
			</div>
